...
<body>
    <nav class="navbar navbar-expand-lg py-md-1 navbar-light bg-light">
        <a class="navbar-brand" href="index.html">
            ...
            <span class="debutTitre">Livr</span><span class="finTitre">aide</span></a>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          <ul class="navbar-nav mr-auto">
            <li class="nav-item"> 
                <a class="btn nav-link btn-light" role="button" href="#buyAnchor">Acheter</a>    
            </li>
            <li class="nav-item">
                <a class="btn nav-link btn-light" role="button" href="#sellAnchor">Vendre</a>   
            </li>
          </ul>
